...
$upload_dir = '/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../images/'; // relative path from filemanager folder to upload folder (with final /)
...
// Remember than the image creation respect the folder hierarchy so if you are inside images/test/test1/ the new image will create at
...
// The image creation path is always relative so if i'm inside images/test/test1 and I upload an image, the path start from here
// 
